...
DEFAULT_COMPUTER_NAME=$(scutil --get ComputerName)
read -p "Name this computer: ($DEFAULT_COMPUTER_NAME) " COMPUTER_NAME
...
# Menu bar: hide the useless Time Machine and Volume icons (on pre-10.8)
